...
ModuleIdentity, Unsigned32, Integer32, NotificationType, Gauge32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, iso, ObjectIdentity, Bits, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType", "Gauge32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "iso", "ObjectIdentity", "Bits", "mib-2", "Counter32")
TruthValue, TimeStamp, AutonomousType, TextualConvention, DisplayString, PhysAddress, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "AutonomousType", "TextualConvention", "DisplayString", "PhysAddress", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", OwnerString=OwnerString, ifOutMulticastPkts=ifOutMulticastPkts, interfaces=interfaces, ifInUcastPkts=ifInUcastPkts, ifCompliance2=ifCompliance2, ifStackStatus=ifStackStatus, ifStackLastChange=ifStackLastChange, ifHCOutOctets=ifHCOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifOutOctets=ifOutOctets, ifRcvAddressTable=ifRcvAddressTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutUcastPkts=ifOutUcastPkts, ifConformance=ifConformance, ifXTable=ifXTable, ifHighSpeed=ifHighSpeed, ifTestCode=ifTestCode, ifTestEntry=ifTestEntry, ifInUnknownProtos=ifInUnknownProtos, ifAlias=ifAlias, ifName=ifName, ifEntry=ifEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestOwner=ifTestOwner, ifStackLowerLayer=ifStackLowerLayer, ifInNUcastPkts=ifInNUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackGroup2=ifStackGroup2, ifOutQLen=ifOutQLen, ifInMulticastPkts=ifInMulticastPkts, ifOutErrors=ifOutErrors, ifDescr=ifDescr, ifInErrors=ifInErrors, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, linkUp=linkUp, linkDown=linkDown, ifCompliances=ifCompliances, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifType=ifType, ifStackTable=ifStackTable, ifInDiscards=ifInDiscards, ifTestType=ifTestType, ifCompliance=ifCompliance, ifMIBObjects=ifMIBObjects, ifRcvAddressAddress=ifRcvAddressAddress, ifOutDiscards=ifOutDiscards, ifXEntry=ifXEntry, ifNumber=ifNumber, ifTestId=ifTestId, ifRcvAddressEntry=ifRcvAddressEntry, ifInOctets=ifInOctets, ifStackHigherLayer=ifStackHigherLayer, PYSNMP_MODULE_ID=ifMIB, ifGeneralGroup=ifGeneralGroup, ifRcvAddressType=ifRcvAddressType, ifHCInOctets=ifHCInOctets, ifTestStatus=ifTestStatus, InterfaceIndex=InterfaceIndex, ifTestTable=ifTestTable, ifOperStatus=ifOperStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIB=ifMIB, ifGroups=ifGroups, ifCompliance3=ifCompliance3, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifTableLastChange=ifTableLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifTestResult=ifTestResult, ifVHCPacketGroup=ifVHCPacketGroup, ifTestGroup=ifTestGroup, ifPhysAddress=ifPhysAddress, ifStackEntry=ifStackEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifTable=ifTable, ifConnectorPresent=ifConnectorPresent, ifSpecific=ifSpecific, ifLastChange=ifLastChange, ifOldObjectsGroup=ifOldObjectsGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifMtu=ifMtu, ifIndex=ifIndex, ifHCPacketGroup=ifHCPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, ifAdminStatus=ifAdminStatus, ifPacketGroup=ifPacketGroup)
