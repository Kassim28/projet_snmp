...
iso, Unsigned32, Integer32, Counter32, Counter64, IpAddress, ModuleIdentity, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, ObjectIdentity, MibIdentifier, Gauge32, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Integer32", "Counter32", "Counter64", "IpAddress", "ModuleIdentity", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "ObjectIdentity", "MibIdentifier", "Gauge32", "TimeTicks", "Bits")
TextualConvention, TimeStamp, TestAndIncr, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TestAndIncr", "DisplayString")
...
mibBuilder.exportSymbols("SNMPv2-MIB", sysContact=sysContact, sysORLastChange=sysORLastChange, snmpOutGetResponses=snmpOutGetResponses, warmStart=warmStart, snmpInGenErrs=snmpInGenErrs, sysObjectID=sysObjectID, snmpMIBGroups=snmpMIBGroups, sysOREntry=sysOREntry, snmpSetSerialNo=snmpSetSerialNo, snmpInGetRequests=snmpInGetRequests, snmpProxyDrops=snmpProxyDrops, snmpOutSetRequests=snmpOutSetRequests, snmp=snmp, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpOutGetNexts=snmpOutGetNexts, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpBasicComplianceRev2=snmpBasicComplianceRev2, sysName=sysName, snmpOutGenErrs=snmpOutGenErrs, snmpGroup=snmpGroup, snmpInBadValues=snmpInBadValues, snmpInTooBigs=snmpInTooBigs, snmpInReadOnlys=snmpInReadOnlys, snmpMIB=snmpMIB, snmpSet=snmpSet, snmpObsoleteGroup=snmpObsoleteGroup, snmpInASNParseErrs=snmpInASNParseErrs, snmpInBadVersions=snmpInBadVersions, snmpBasicCompliance=snmpBasicCompliance, snmpInSetRequests=snmpInSetRequests, snmpSetGroup=snmpSetGroup, snmpNotificationGroup=snmpNotificationGroup, snmpOutTraps=snmpOutTraps, snmpTrapOID=snmpTrapOID, systemGroup=systemGroup, sysORID=sysORID, snmpOutBadValues=snmpOutBadValues, snmpInNoSuchNames=snmpInNoSuchNames, snmpMIBObjects=snmpMIBObjects, sysDescr=sysDescr, snmpOutTooBigs=snmpOutTooBigs, snmpInGetResponses=snmpInGetResponses, sysORUpTime=sysORUpTime, sysUpTime=sysUpTime, sysServices=sysServices, snmpInTraps=snmpInTraps, coldStart=coldStart, authenticationFailure=authenticationFailure, sysORDescr=sysORDescr, sysORIndex=sysORIndex, snmpMIBCompliances=snmpMIBCompliances, snmpOutGetRequests=snmpOutGetRequests, PYSNMP_MODULE_ID=snmpMIB, sysLocation=sysLocation, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpInTotalReqVars=snmpInTotalReqVars, snmpTrap=snmpTrap, snmpInTotalSetVars=snmpInTotalSetVars, snmpInGetNexts=snmpInGetNexts, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpTrapEnterprise=snmpTrapEnterprise, snmpInPkts=snmpInPkts, snmpTraps=snmpTraps, snmpSilentDrops=snmpSilentDrops, snmpMIBConformance=snmpMIBConformance, sysORTable=sysORTable, snmpOutPkts=snmpOutPkts, system=system, snmpCommunityGroup=snmpCommunityGroup)
