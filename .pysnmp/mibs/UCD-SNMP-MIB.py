...
# ASN.1 source file:///usr/share/snmp/mibs/UCD-SNMP-MIB.txt
...
MibIdentifier, Bits, IpAddress, Counter32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, TimeTicks, ModuleIdentity, Opaque, enterprises, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "Counter32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "TimeTicks", "ModuleIdentity", "Opaque", "enterprises", "Integer32", "Unsigned32", "NotificationType")
TruthValue, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DisplayString")
ucdavis = ModuleIdentity((1, 3, 6, 1, 4, 1, 2021))
ucdavis.setRevisions(('2016-06-10 00:00', '2011-05-14 00:00', '2009-01-19 00:00', '2006-11-22 00:00', '2004-04-07 00:00', '2002-09-05 00:00', '2001-09-20 00:00', '2001-01-17 00:00', '1999-12-09 00:00',))
...
mibBuilder.exportSymbols("UCD-SNMP-MIB", prNames=prNames, ucdavis=ucdavis, memAvailRealTXT=memAvailRealTXT, extNames=extNames, memTotalFree=memTotalFree, UCDErrorFix=UCDErrorFix, dskAvailHigh=dskAvailHigh, ucdSnmpAgent=ucdSnmpAgent, unknown=unknown, ssCpuSystem=ssCpuSystem, ucdShutdown=ucdShutdown, irix=irix, prTable=prTable, logMatchGlobalCounter=logMatchGlobalCounter, ssIORawSent=ssIORawSent, dskAvail=dskAvail, memErrorName=memErrorName, ssSysInterrupts=ssSysInterrupts, prErrFixCmd=prErrFixCmd, ssRawSwapIn=ssRawSwapIn, win32=win32, dskTotalHigh=dskTotalHigh, laEntry=laEntry, ssRawInterrupts=ssRawInterrupts, dskUsed=dskUsed, laIndex=laIndex, prMin=prMin, dskPercent=dskPercent, dskIndex=dskIndex, dskTotalLow=dskTotalLow, memSharedX=memSharedX, versionRestartAgent=versionRestartAgent, fileEntry=fileEntry, logMatchFilename=logMatchFilename, laLoad=laLoad, freebsd=freebsd, memCachedX=memCachedX, macosx=macosx, memTotalReal=memTotalReal, prEntry=prEntry, laErrMessage=laErrMessage, ssRawContexts=ssRawContexts, memCached=memCached, versionIndex=versionIndex, dskDevice=dskDevice, memAvailReal=memAvailReal, extIndex=extIndex, logMatchCurrentCount=logMatchCurrentCount, memory=memory, ssRawSwapOut=ssRawSwapOut, laLoadInt=laLoadInt, dskTable=dskTable, logMatchIndex=logMatchIndex, extEntry=extEntry, snmperrErrorFlag=snmperrErrorFlag, snmperrNames=snmperrNames, osf=osf, fileIndex=fileIndex, versionDoDebugging=versionDoDebugging, memIndex=memIndex, logMatchCurrentCounter=logMatchCurrentCounter, extErrFixCmd=extErrFixCmd, logMatchCounter=logMatchCounter, dskMinPercent=dskMinPercent, dskUsedHigh=dskUsedHigh, memTotalRealTXT=memTotalRealTXT, dskMinimum=dskMinimum, mrIndex=mrIndex, ssIOReceive=ssIOReceive, memShared=memShared, dskPercentNode=dskPercentNode, hpux10=hpux10, snmperrErrMessage=snmperrErrMessage, fileTable=fileTable, dskErrorFlag=dskErrorFlag, dskErrorMsg=dskErrorMsg, dskTotal=dskTotal, fileErrorMsg=fileErrorMsg, extResult=extResult, versionSavePersistentData=versionSavePersistentData, prCount=prCount, memMinimumSwap=memMinimumSwap, memAvailSwapTXT=memAvailSwapTXT, ssCpuRawUser=ssCpuRawUser, fileName=fileName, ssSwapOut=ssSwapOut, prErrorFlag=prErrorFlag, versionCDate=versionCDate, laErrorFlag=laErrorFlag, logMatchName=logMatchName, logMatchGlobalCount=logMatchGlobalCount, UCDErrorFlag=UCDErrorFlag, ssCpuRawWait=ssCpuRawWait, memTotalSwap=memTotalSwap, versionConfigureOptions=versionConfigureOptions, ssCpuRawIdle=ssCpuRawIdle, memBufferX=memBufferX, bsdi=bsdi, prErrFix=prErrFix, ucdTraps=ucdTraps, ucdStart=ucdStart, solaris=solaris, version=version, dskUsedLow=dskUsedLow, snmperrs=snmperrs, ssCpuRawSystem=ssCpuRawSystem, logMatchCount=logMatchCount, ssIOSent=ssIOSent, netbsd1=netbsd1, prMax=prMax, mrModuleName=mrModuleName, logMatch=logMatch, logMatchCycle=logMatchCycle, ssSysContext=ssSysContext, dskPath=dskPath, PYSNMP_MODULE_ID=ucdavis, prErrMessage=prErrMessage, Float=Float, logMatchMaxEntries=logMatchMaxEntries, memUsedSwapTXT=memUsedSwapTXT, versionUpdateConfig=versionUpdateConfig, memAvailRealX=memAvailRealX, dragonfly=dragonfly, extOutput=extOutput, laTable=laTable, systemStats=systemStats, sunos4=sunos4, memTotalSwapX=memTotalSwapX, ssSwapIn=ssSwapIn, openbsd=openbsd, extErrFix=extErrFix, dskAvailLow=dskAvailLow, ssCpuRawGuest=ssCpuRawGuest, logMatchRegExCompilation=logMatchRegExCompilation, logMatchRegEx=logMatchRegEx, mrEntry=mrEntry, versionClearCache=versionClearCache, memSwapErrorMsg=memSwapErrorMsg, prIndex=prIndex, memSwapError=memSwapError, ucdInternal=ucdInternal, memMinimumSwapX=memMinimumSwapX, extTable=extTable, memTotalRealX=memTotalRealX, extCommand=extCommand, ssCpuRawInterrupt=ssCpuRawInterrupt, versionDate=versionDate, snmperrIndex=snmperrIndex, laConfig=laConfig, ultrix=ultrix, hpux11=hpux11, linux=linux, memAvailSwap=memAvailSwap, memAvailSwapX=memAvailSwapX, ssCpuRawGuestNice=ssCpuRawGuestNice, ssCpuRawKernel=ssCpuRawKernel, ssCpuRawSoftIRQ=ssCpuRawSoftIRQ, ssCpuRawSteal=ssCpuRawSteal, logMatchEntry=logMatchEntry, versionIdent=versionIdent, ssCpuRawNice=ssCpuRawNice, memUsedRealTXT=memUsedRealTXT, memTotalFreeX=memTotalFreeX, versionTag=versionTag, ssCpuIdle=ssCpuIdle, ssCpuUser=ssCpuUser, fileSize=fileSize, ssIndex=ssIndex, ucdExperimental=ucdExperimental, hpux9=hpux9, memTotalSwapTXT=memTotalSwapTXT, ssErrorName=ssErrorName, fileErrorFlag=fileErrorFlag, laLoadFloat=laLoadFloat, ssIORawReceived=ssIORawReceived, fileMax=fileMax, mrTable=mrTable, memBuffer=memBuffer, laNames=laNames, aix=aix, logMatchErrorFlag=logMatchErrorFlag, dskEntry=dskEntry, logMatchTable=logMatchTable)
